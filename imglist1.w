...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <div component="$UI/system/components/justep/list/list" class="x-list x-cards" xid="list1" data="data1" limit="6" disablePullToRefresh="false" autoLoad="true">
     ...
     <a itemprop="contentUrl" data-size="400x600" style="width:100%;display:block;background-color:#eee;height:200px;" bind-attr-href='$object.val("path")'>
  ...
  </div></div> </div><div class="x-contents-content x-scroll-view" xid="content4" onActive="localDataCustomRefresh"><div class="x-scroll" component="$UI/system/components/justep/scrollView/scrollView" xid="scrollView1" noMoreLoadLabel="没有未同步订单了。" hideScrollbar="true" bounce="false">
